...
@Controller
public class InstantErrorController implements ErrorController {
     ...
     * @return
     */
    @RequestMapping(value = Mappings.ERROR_PATH, produces = "text/html")
     ...
     * @return
     */
    @RequestMapping(value = Mappings.ERROR_PATH)
    @ResponseBody
